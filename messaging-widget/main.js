...
class MessageWidget {
  ...
  getPosition(position) {
    // Logic to determine widget position based on input
    // This method should return an object with CSS properties
  ...
  createWidgetContent() {
    this.widgetContainer.innerHTML = `
        ...
        <main class="widget__body">
              <a href="https://api.whatsapp.com/send?phone=9758187694" class="api_link">Connect With US!</a>
